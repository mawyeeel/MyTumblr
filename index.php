...
$acc_username = "MarielleLimbo";
$acc_password = "marielle54321";
$acc_fullname = "Marielle Angel Charishe Limbo";
$acc_adress = "Boac, Marinduque  PH";
...
if(isset($_REQUEST['login_button']) === true){
  ...
  //kapag mali agad yung username
   ...
   //tama ang username at password 
     ...
     $_SESSION['ses_adress'] = $acc_adress;
